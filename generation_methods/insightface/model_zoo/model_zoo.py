...
import glob
import onnxruntime
import generation_methods.insightface
import pdb
...
path_to_module = './generation_methods/insightface/model_zoo'
module_name = 'generation_methods.insightface.model_zoo.arcface_onnx'
spec = importlib.util.spec_from_file_location(module_name, f"{path_to_module}/arcface_onnx.py")
module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(module)

# arcface_onnx = insightface.model_zoo.arcface_onnx
ArcFaceONNX = module.ArcFaceONNX

from generation_methods.insightface.model_zoo.retinaface import *
from generation_methods.insightface.model_zoo.landmark import *
from generation_methods.insightface.model_zoo.attribute import Attribute
from generation_methods.insightface.model_zoo.inswapper import INSwapper
from generation_methods.insightface.utils import download_onnx
